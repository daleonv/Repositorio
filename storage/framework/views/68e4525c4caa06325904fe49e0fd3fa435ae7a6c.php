        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?php echo e(route('permiso')); ?>" class="btn btn-outline-secondary btn-sm">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('actualizar_permiso',[$data->id])); ?>" id="form-general">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("theme.$theme.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/admin/permiso/editar.blade.php ENDPATH**/ ?>