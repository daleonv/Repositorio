...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('actualizar_usuario',['id'=>$usuarios->id])); ?>" id="form-general">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("theme.$theme.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/admin/usuario/editar.blade.php ENDPATH**/ ?>