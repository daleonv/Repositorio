    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Crear Áreas de Conocimiento</h3>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('guardar_area_conocimiento')); ?>" id="form-general">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("theme.$theme.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/area-conocimiento/crear.blade.php ENDPATH**/ ?>